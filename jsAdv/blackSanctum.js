    ...
    locs:[{
        ...
        { //15
            desc: "I'm in an impressive room with a cathedral ceiling",
            d: { n: 7 },
            ...
            play: [
                ...
                { n: "orga", inv: [], say: "What should I play?" },
                {
                    n: "bach",
                    inv: ["musi"],
                    say: "It makes a magnificent sound. Hey, the organ moved.",
                    miss: "I have no sheet music.",
        ...
        { //17
            ...
            i: [{
                    ...
                    w: -1,
                    l: "The door is nailed shut from the other side",
        ...
        { //18
            desc: "I'm in an underground crypt",
            d: { s: 17, coff: { n: 18, status: "c" } },
            dark: true,
            i: [{
                    n: "a coffin",
                    l: "it looks interesting alright!",
                    w: -1,
                    o: "Gulp... I found a skeleton dressed in ministerial robes"
                }, // an open coffin
            ...
            list: [{
                n: "*",
                test: "cl.d.coff.status === 'c';",
                testFail: "I don't hear anything now...", //todo: coff is open
                inRoom: ["alter", "sheet", "hair", "salt", "feat", "water", "need"],
            ...
            make: [{
                n: "alter",
                inRoom: ["hammer", "hand saw", "nails", "boards"],
                miss: "I can't do that... I'm missing something.",
                say: "That was hard work!",
                rooms: [{
                    id: 18,
